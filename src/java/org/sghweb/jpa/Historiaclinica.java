...
@NamedQueries({
    ...
    @NamedQuery(name = "Historiaclinica.findByDni", query = "SELECT h FROM Historiaclinica h WHERE h.historiaclinicaPK.dni = :dni"),
...
public class Historiaclinica implements Serializable {
    ...
    public Historiaclinica(String numeroRegistro, String autogenerado, String dni) {
        this.historiaclinicaPK = new HistoriaclinicaPK(numeroRegistro, autogenerado, dni);
    }
